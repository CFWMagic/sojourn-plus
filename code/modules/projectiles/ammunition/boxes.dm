...
/obj/item/ammo_magazine/ammobox/rifle_75
	...
	desc = "A box of 7.62mm rifle ammunition. 200ct, Full Metal Jacket rounds."
	matter = list(MATERIAL_STEEL = 10)
	w_class = ITEM_SIZE_BULKY
	caliber = CAL_RIFLE
	mag_type = MAGAZINE
...
/obj/item/ammo_magazine/ammobox/rifle_75_small/laser
	...
	desc = "A box of 7.62mm rifle ammunition. 60ct, laser core rounds. You can see caliber information on the label."
...
/obj/item/ammo_magazine/ammobox/c10x24_small
	...
	caliber = "10x24"
	ammo_type = /obj/item/ammo_casing/c10x24
	max_ammo = 100 // 80//6.6 reloads of the SWAT, 2 of the bond, almost 1 full pulse mag
...
/obj/item/ammo_magazine/ammobox/shotgun/flashshells
	...
	max_ammo = 80 //2x the ammo for being map spawned
